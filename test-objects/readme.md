...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
TDD is a different way of thinking, and learning to write good tests or specs is a journey.  Ultimately we want tests that properly islolate the topic, which often means utilizing special kinds of objects, just for testing.  Martin Fowler calls these special objects "[Doubles]," though quite often people refer to all doubles as mocks.  Let's look at some different kinds of doubles and how they help us isolate what we're testing.
